...
public class FindReviewByEmployerController {

	final PersistanceAdapterReview repo;
	
	public FindReviewByEmployerController(PersistanceAdapterReview repo) {
		this.repo = repo;
	}
    ...
    public List<ReviewDTO> findReviewByEmployer(@PathVariable("id") Integer id){
